...
var background3 = document.querySelector(".backgrounnd-3");
var imgbackground2 = document.querySelector(".img-background-2");
function backgroundone() {}

function backgroundtwo() {
  background2.classList.add("open-background-2");
  imgbackground2.classList.add("opacity-background-2");
  background3.classList.add("none-background-3");
}
